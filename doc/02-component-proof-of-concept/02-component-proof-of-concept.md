...
I am going to  move forward with the Circuit component. This design seems to be the
easiest to flesh out within the Semester. I am in CSE engineering but I am loving my
circuits class currently. I also think I can add some things to it to make it
complicated enough to be fun to implement. such as the ability to add circuits
in parallel. I would at some point like to mess with Location Matrix but I don't
see myself currently being able to manipulate arrays well enough to make move
objects around.
